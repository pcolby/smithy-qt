...
Renderer::Renderer(const QDir &outputDir)
    : outputDir(outputDir)
{
...
int Renderer::generate(const QFileInfoList &descriptions)
{
    modules.clear();
    int count = 0;
...
int Renderer::generate(const QString &serviceFileName,
...
QStringList Renderer::formatHtmlDocumentation(const QString &html)
{
...
bool Renderer::generateModelClasses(Grantlee::Context &context, const QString &projectDir,
...
QString Renderer::getServiceName(const QJsonObject &metaData)
{
...
bool Renderer::render(const QString &templateName, Grantlee::Context &context,
...
void Renderer::renderClassFiles(const QString &templateBaseName, Grantlee::Context &context,
